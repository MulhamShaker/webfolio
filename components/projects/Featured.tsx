...
//
// import { cx } from '@/config/projectsConfig'
...
const Featured = ({ secondary, live, thumnail, code, title, description, tech } : ProjectTypes) => {
  ...
  const __renderContent = () => {
    return (
        <div className='col-span-12 sm:col-span-5 text-right sm:absolute sm:left-[50%] !relative z-[100] !left-0 !text-start sm:w-[120%]'>
            <div>
                ...
                <div className='flex text-slate-400 ml-10 gap-x-4 justify-center flex-wrap mr-[8rem]' >
